...
class BaseModel
{
	...
	{
		$conn = new PDO('mysql:host=127.0.0.1;dbname=truongnnph15584_php2;charset=utf8', 'root', '');
		return $conn;
	}
	...
	public function select_items($sql_all)
	{
		$stmt = $this->getConnect()->prepare($sql_all);
		$stmt->execute();
		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
		return $result;
	}
	public function get_id_new()
	{
		$last_id = $this->getConnect()->lastInsertId();
		return $last_id;
	}
